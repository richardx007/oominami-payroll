...
> 変更した（管理者・従業員とも、PC/iPadの縦サイドバーとスマホのメニューの両方）。以下は切替前の記録。**
...
- サイドバー「関連情報 > 営業カレンダー」（管理者・従業員）は **2026-09-18 にこのページ（`/calendar/embed`、別タブ）へ
  切り替え済み**（旧アプリのポスター表示URLから変更。§10.3）。管理者の「管理 > 営業カレンダー」は従来どおり `/admin/calendar`。
